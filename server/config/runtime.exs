...
#
#     PHX_SERVER=true bin/pulsekit start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :pulsekit, PulsekitWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /app/data/pulsekit.db
      """

  config :pulsekit, Pulsekit.Repo,
  ...
  config :pulsekit, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
